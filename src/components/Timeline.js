...
const MyTimeline = () => {
  return (
    <Timeline sx={{
      ...
      <TimelineCard activity="Restructured the website's information architecture and redefined the scope of editable content" details="Redefined the types of user roles, what they can typically do (use cases), and what information each role can edit."/>
